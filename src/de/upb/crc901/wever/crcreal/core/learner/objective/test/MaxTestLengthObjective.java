...
public class MaxTestLengthObjective extends AbstractTestObjective {

	public final static String ID = "crc.real.objective.test.maxtestlength";
	...
	public AbstractObjective newInstance() {
		return new MaxTestLengthObjective();
	}
